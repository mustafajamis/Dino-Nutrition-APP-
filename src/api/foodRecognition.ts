...
function convertNutritionToGrams(nutrition: NutritionData): NutritionData {
  ...
  if (nutrition.totalFat !== undefined) {
    converted.totalFat = nutrition.totalFat * 1000;
  }
  if (nutrition.saturatedFat !== undefined) {
    converted.saturatedFat = nutrition.saturatedFat * 1000;
  }
  if (nutrition.transFat !== undefined) {
    converted.transFat = nutrition.transFat * 1000;
  }
  if (nutrition.cholesterol !== undefined) {
    converted.cholesterol = nutrition.cholesterol * 1000;
  }
  if (nutrition.sodium !== undefined) {
    converted.sodium = nutrition.sodium * 1000;
  }
  if (nutrition.totalCarbs !== undefined) {
    converted.totalCarbs = nutrition.totalCarbs * 1000;
  }
  if (nutrition.dietaryFiber !== undefined) {
    converted.dietaryFiber = nutrition.dietaryFiber * 1000;
  }
  if (nutrition.sugars !== undefined) {
    converted.sugars = nutrition.sugars * 1000;
  }
  if (nutrition.protein !== undefined) {
    converted.protein = nutrition.protein * 1000;
  }
  if (nutrition.calcium !== undefined) {
    converted.calcium = nutrition.calcium * 1000;
  }
  if (nutrition.iron !== undefined) {
    converted.iron = nutrition.iron * 1000;
  }
  if (nutrition.potassium !== undefined) {
    converted.potassium = nutrition.potassium * 1000;
  }
  if (nutrition.vitaminA !== undefined) {
    converted.vitaminA = nutrition.vitaminA * 1000;
  }
  if (nutrition.vitaminC !== undefined) {
    converted.vitaminC = nutrition.vitaminC * 1000;
  }
  if (nutrition.monounsaturatedFat !== undefined) {
    converted.monounsaturatedFat = nutrition.monounsaturatedFat * 1000;
  }
  if (nutrition.polyunsaturatedFat !== undefined) {
    converted.polyunsaturatedFat = nutrition.polyunsaturatedFat * 1000;
  }

  // Calories stay as-is (they're already in kcal per 1kg)
  if (nutrition.calories !== undefined) {
    converted.calories = nutrition.calories;
  }
...
export function getNutritionPer100g(nutrition: NutritionData, servingWeight: number = 0.1): NutritionData {
  ...
  if (nutrition.calories !== undefined) {
    result.calories = Math.round(nutrition.calories * multiplier);
  }
  if (nutrition.totalFat !== undefined) {
    result.totalFat = Math.round(nutrition.totalFat * multiplier * 100) / 100;
  }
  if (nutrition.saturatedFat !== undefined) {
    result.saturatedFat = Math.round(nutrition.saturatedFat * multiplier * 100) / 100;
  }
  if (nutrition.totalCarbs !== undefined) {
    result.totalCarbs = Math.round(nutrition.totalCarbs * multiplier * 100) / 100;
  }
  if (nutrition.protein !== undefined) {
    result.protein = Math.round(nutrition.protein * multiplier * 100) / 100;
  }
  if (nutrition.sodium !== undefined) {
    result.sodium = Math.round(nutrition.sodium * multiplier * 100) / 100;
  }
  if (nutrition.sugars !== undefined) {
    result.sugars = Math.round(nutrition.sugars * multiplier * 100) / 100;
  }
